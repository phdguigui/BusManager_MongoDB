    ...
    public class BusView
    {
        ...
        private static void ShowAllBuses()
        {
            ...
            if (busList is not null)
            {
                ...
                {
                    Console.WriteLine($"{bus.Id.ToString().PadRight(26)}" +
                        $"{bus.Model.PadRight(20)}" +
        ...
        private static void ShowDeleteBus()
        {
            ...
            if (bus is not null)
            {
                if (_tripService.GetTripsByBusId(bus.Id) is null || _tripService.GetTripsByBusId(bus.Id).Count > 0)
                {
                    Console.Clear();
